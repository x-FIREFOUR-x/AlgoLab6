...
public:
    ...
    void setupUi(QDialog *WindowSuit)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/image/PNG-cards/other/hearts.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/image/PNG-cards/other/clubs.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/image/PNG-cards/other/diamonds.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/image/PNG-cards/other/spades.png"), QSize(), QIcon::Normal, QIcon::Off);
